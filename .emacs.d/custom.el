(custom-set-variables
 ...
 '(package-selected-packages
	 (quote
		(yaml-mode yasnippet use-package rust-mode projectile powerline-evil org nix-sandbox magit linum-relative key-chord hamlet-mode flycheck-pos-tip flycheck-haskell ess cython-mode company-quickhelp company-nixos-options company-jedi auctex-latexmk ace-jump-mode wc-mode python-mode evil-nerd-commenter)))
